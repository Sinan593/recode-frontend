        ...
        <>
            <div className="navbar flex flex-row bg-black text-white p-4 pr-16 pl-16 justify-between items-center">
                ...
                <div className="middle flex flex-row gap-8">
                    <Link to="/code-convertor" className="hover:text-purple-400 hover:text-xl">Code Convertor</Link>
                    <Link to="/cli-guide" className="hover:text-purple-400 hover:text-xl">CLI Guide</Link>
                    <Link to="/documentation" className="hover:text-purple-400 hover:text-xl">Documentation</Link>
                </div>
                {showButton && (
                    <div className="right">
